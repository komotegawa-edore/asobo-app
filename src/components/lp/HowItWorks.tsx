...
export default function HowItWorks() {
  return (
    <section id="how" className="py-20 sm:py-24 bg-gradient-to-b from-[var(--cream)] to-white">
      <div className="max-w-[1180px] mx-auto px-5 sm:px-7">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr_auto_1fr] gap-6 lg:gap-4 items-stretch mt-14">
          ...
          >
            <div
              className="absolute -top-3.5 left-4 w-9 h-9 rounded-full bg-coral text-white flex items-center justify-center font-black text-lg shadow-[0_4px_0_rgba(218,69,90,.45)]"
            ...
            <div className="flex gap-2 p-2 rounded-[10px] bg-[var(--cream)] mb-1.5 items-center">
              <Image
                src="/images/photos/concert.png"
                alt="ライブ"
                width={36}
                height={36}
                className="rounded-md shrink-0 object-cover w-9 h-9"
              />
              <div>
            ...
            <div className="flex gap-2 p-2 rounded-[10px] bg-[var(--cream)] items-center">
              <Image
          ...
          >
            ...
            <div className="flex flex-col items-center bg-[var(--cream)] rounded-xl p-3.5">
              <div className="w-14 h-14 rounded-full mb-2 bg-gradient-to-br from-[#FFE0A8] to-[var(--peach)] overflow-hidden flex items-center justify-center">
                <Image
          ...
          >
            ...
            <div className="bg-[var(--cream)] rounded-xl p-2.5 flex flex-col gap-1.5">
              <div className="text-[11px] py-1.5 px-2.5 rounded-xl rounded-bl-sm bg-[#F4ECE2] text-[var(--ink)] self-start max-w-[80%] leading-[1.4]">
                楽しみにしてます！
                <br />
                当日はお願いします☺
              </div>
