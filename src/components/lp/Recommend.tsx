      ...
      <div className="max-w-[1180px] mx-auto px-7">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
          {recs.map((r, i) => (
            ...
            >
              <div
                className={`w-24 h-24 rounded-full mx-auto mb-4 bg-gradient-to-br ${r.bg} overflow-hidden flex items-end justify-center`}
              >
                <Image
                  src={r.image}
                  alt={r.title}
