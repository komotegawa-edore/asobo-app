...
export default function Safety() {
  return (
    <section id="safety" className="py-18 bg-[#FFFBF3] relative safety-bg">
      <div className="max-w-[1180px] mx-auto px-7 relative z-[1]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {items.map((item, i) => (
            <div
              key={i}
              className="bg-white rounded-[18px] p-6 px-5 border border-line"
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-2.5">
                <Image src={item.badge} alt="" width={32} height={32} />
